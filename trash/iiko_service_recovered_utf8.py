...
from app.core.database import engine, get_session_sync
...
# ╨Я╨╛╨┤╨░╨▓╨╗╤П╨╡╨╝ ╨┐╤А╨╡╨┤╤Г╨┐╤А╨╡╨╢╨┤╨╡╨╜╨╕╤П ╨╛╨▒ ╨╛╤В╤Б╤Г╤В╤Б╤В╨▓╨╕╨╕ ╨┐╤А╨╛╨▓╨╡╤А╨║╨╕ SSL ╤Б╨╡╤А╤В╨╕╤Д╨╕╨║╨░╤В╨░
# (╨╕╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╡╤В╤Б╤П ╨┐╤А╨╕ ╨╜╨╡╨║╨╛╤В╨╛╤А╤Л╤Е HTTP ╨▓╤Л╨╖╨╛╨▓╨░╤Е ╨║ iiko Server)
if HAS_URLLIB3:
...
class IikoService:
    ...
    def insecure_client(self) -> httpx.AsyncClient:
        """╨Ы╨╡╨╜╨╕╨▓╨░╤П ╨╕╨╜╨╕╤Ж╨╕╨░╨╗╨╕╨╖╨░╤Ж╨╕╤П ╨║╨╗╨╕╨╡╨╜╤В╨░ ╨▒╨╡╨╖ ╨┐╤А╨╛╨▓╨╡╤А╨║╨╕ SSL (╨┤╨╗╤П iiko Server/Resto)"""
    ...
    def _get_settings_by_org_id(self, organization_id: str) -> Optional[IikoSettings]:
        """
        ╨Я╨╛╨╗╤Г╤З╨╡╨╜╨╕╨╡ ╨╜╨░╤Б╤В╤А╨╛╨╡╨║ API ╨╕╨╖ ╨С╨Ф ╨┐╨╛ organization_id ╤Б ╨╕╤Б╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╨╜╨╕╨╡╨╝ ╨║╤Н╤И╨╕╤А╨╛╨▓╨░╨╜╨╕╤П.
        """
        ...
        try:
            # ╨Ш╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╡╨╝ ╤Б╨╕╨╜╤Е╤А╨╛╨╜╨╜╤Г╤О ╤Б╨╡╤Б╤Б╨╕╤О ╨▓ ╨╛╤В╨┤╨╡╨╗╤М╨╜╨╛╨╝ ╨┐╨╛╤В╨╛╨║╨╡, ╤З╤В╨╛╨▒╤Л ╨╜╨╡ ╨▒╨╗╨╛╨║╨╕╤А╨╛╨▓╨░╤В╤М Event Loop
            # ╨Ф╨╗╤П ╤Г╨┐╤А╨╛╤Й╨╡╨╜╨╕╤П ╨╖╨┤╨╡╤Б╤М ╨╕╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╡╨╝ get_session_sync
    ...
    async def _get_access_token(self, api_login: Optional[str] = None) -> str:
        """
        ╨Я╨╛╨╗╤Г╤З╨╡╨╜╨╕╨╡ ╤В╨╛╨║╨╡╨╜╨░ ╨┤╨╛╤Б╤В╤Г╨┐╨░ ╨║ iiko API ╤Б ╨╕╤Б╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╨╜╨╕╨╡╨╝ ╨▒╨╗╨╛╨║╨╕╤А╨╛╨▓╨║╨╕ ╨┤╨╗╤П ╨┐╤А╨╡╨┤╨╛╤В╨▓╤А╨░╤Й╨╡╨╜╨╕╤П race conditions.
        """
        ...
        # 1. ╨С╤Л╤Б╤В╤А╨░╤П ╨┐╤А╨╛╨▓╨╡╤А╨║╨░ ╨▒╨╡╨╖ ╨▒╨╗╨╛╨║╨╕╤А╨╛╨▓╨║╨╕ (╨╡╤Б╨╗╨╕ ╤В╨╛╨║╨╡╨╜ ╨╡╤Й╨╡ ╨▓╨░╨╗╨╕╨┤╨╡╨╜)
        if not api_login and self.access_token and self.token_expires_at:
            if now < self.token_expires_at:
                return self.access_token

        # 2. ╨Х╤Б╨╗╨╕ ╨╜╤Г╨╢╨╡╨╜ ╨╜╨╛╨▓╤Л╨╣ ╤В╨╛╨║╨╡╨╜ тАФ ╨╕╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╡╨╝ Lock, ╤З╤В╨╛╨▒╤Л ╤В╨╛╨╗╤М╨║╨╛ ╨╛╨┤╨╜╨░ ╨║╨╛╤А╤Г╤В╨╕╨╜╨░ ╨┤╨╡╨╗╨░╨╗╨░ ╨╖╨░╨┐╤А╨╛╤Б
        async with self._token_lock:
            # ╨Я╨╛╨▓╤В╨╛╤А╨╜╨░╤П ╨┐╤А╨╛╨▓╨╡╤А╨║╨░ ╨▓╨╜╤Г╤В╤А╨╕ ╨▒╨╗╨╛╨║╨╕╤А╨╛╨▓╨║╨╕ (double-checked locking)
            if not api_login and self.access_token and self.token_expires_at:
                if now < self.token_expires_at:
                    return self.access_token
            ...
            try:
                ...
                try:
                    ...
                    err_text = str(e)
                logger.error(f"╨Э╨╡ ╤Г╨┤╨░╨╗╨╛╤Б╤М ╨┐╨╛╨╗╤Г╤З╨╕╤В╤М ╤В╨╛╨║╨╡╨╜ ╨┤╨╛╤Б╤В╤Г╨┐╨░: {err_text}")
                raise
            except Exception as e:
                logger.error(f"╨Ъ╤А╨╕╤В╨╕╤З╨╡╤Б╨║╨░╤П ╨╛╤И╨╕╨▒╨║╨░ ╨┐╤А╨╕ ╨┐╨╛╨╗╤Г╤З╨╡╨╜╨╕╨╕ ╤В╨╛╨║╨╡╨╜╨░ iiko: {e}")
                raise
    ...
    async def _request(
        ...
        try:
            ...
            # ╨Ю╨▒╤А╨░╨▒╨╛╤В╨║╨░ 429 (Too Many Requests) - ╨н╨║╤Б╨┐╨╛╨╜╨╡╨╜╤Ж╨╕╨░╨╗╤М╨╜╤Л╨╣ ╨▒╤Н╨║╤Е╨╛╤Д╤Д
            ...
            if response.status_code >= 400:
                if log_error:
                    ...
                    # ╨б╨┐╨╡╤Ж╨╕╨░╨╗╤М╨╜╨╛╨╡ ╤Г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╨╡ ╨┤╨╗╤П ╨╛╤И╨╕╨▒╨╛╨║ ╨┐╤А╨░╨▓ (Rights)
                    if "is not allowed for this ApiLogin" in body:
                        logger.warning(f"╨Ю╨и╨Ш╨С╨Ъ╨Р ╨Я╨а╨Р╨Т IIKO: ╨Ф╨╗╤П API Login ╨╜╨╡ ╤А╨░╨╖╤А╨╡╤И╨╡╨╜ ╨┤╨╛╤Б╤В╤Г╨┐ ╨║ {endpoint}. ╨Я╤А╨╛╨▓╨╡╤А╤М╤В╨╡ ╨╜╨░╤Б╤В╤А╨╛╨╣╨║╨╕ ╨▓ ╨Ы╨Ъ iiko Cloud.")
                response.raise_for_status()
    ...
    async def get_customer_orders_history(
        ...
        """
        ╨Я╨╛╨╗╤Г╤З╨╡╨╜╨╕╨╡ ╨╕╤Б╤В╨╛╤А╨╕╨╕ ╨╖╨░╨║╨░╨╖╨╛╨▓ ╨│╨╛╤Б╤В╤П ╨┐╨╛ ╨╜╨╛╨╝╨╡╤А╤Г ╤В╨╡╨╗╨╡╤Д╨╛╨╜╨░.
        ╨Ю╨▒╤Л╤З╨╜╨╛ iiko ╤Е╤А╨░╨╜╨╕╤В ╨┤╨╡╤В╨░╨╗╨╕ ╨╖╨░╨║╨░╨╖╨╛╨▓ ╨╖╨░ ╨┐╨╛╤Б╨╗╨╡╨┤╨╜╨╕╨╡ 90 ╨┤╨╜╨╡╨╣, ╨╜╨╛ ╤З╨╡╤А╨╡╨╖ 
        ╤Н╤В╨╛╤В ╨╝╨╡╤В╨╛╨┤ ╨╝╨╛╨╢╨╜╨╛ ╨┐╨╛╨╗╤Г╤З╨╕╤В╤М ╤Б╨┐╨╕╤Б╨╛╨║ ╨╕ ╨╖╨░ ╨▒╨╛╨╗╨╡╨╡ ╨┤╨╛╨╗╨│╨╕╨╣ ╨┐╨╡╤А╨╕╨╛╨┤.
        """
        org_id = organization_id or self.organization_id
        ...
        logger.info(f"╨Ч╨░╨┐╤А╨╛╤Б ╨╕╤Б╤В╨╛╤А╨╕╨╕ ╨╖╨░╨║╨░╨╖╨╛╨▓ iiko ╨┤╨╗╤П ╤В╨╡╨╗╨╡╤Д╨╛╨╜╨░: {phone}")
        ...
        logger.info(f"╨Я╨╛╨╗╤Г╤З╨╡╨╜╨╛ {len(orders)} ╨╖╨░╨║╨░╨╖╨╛╨▓ ╨╕╨╖ ╨╕╤Б╤В╨╛╤А╨╕╨╕ iiko ╨┤╨╗╤П {phone}")
        return orders
    ...
    async def get_customer_bonus_history(
        ...
        if not date_to:
            date_to = datetime.now(timezone.utc).strftime(date_format)
        else:
            try:
    ...
    async def sync_full_customer_data(
        ...
        """
        ╨Ъ╨╛╨╝╨┐╨╗╨╡╨║╤Б╨╜╨░╤П ╤Б╨╕╨╜╤Е╤А╨╛╨╜╨╕╨╖╨░╤Ж╨╕╤П ╨▓╤Б╨╡╤Е ╨┤╨░╨╜╨╜╤Л╤Е ╨│╨╛╤Б╤В╤П:
        1. ╨Я╤А╨╛╤Д╨╕╨╗╤М ╨╕ ╨▒╨░╨╗╨░╨╜╤Б (Cloud API)
        2. ╨Ш╤Б╤В╨╛╤А╨╕╤П ╨▒╨╛╨╜╤Г╤Б╨╛╨▓ (Cloud API)
        3. ╨Р╨╜╨░╨╗╨╕╤В╨╕╨║╨░ (Server API OLAP)
        4. ╨Ш╤Б╤В╨╛╤А╨╕╤П ╨╖╨░╨║╨░╨╖╨╛╨▓ (Server API OLAP)
        """
        org_id = organization_id or self.organization_id
        
        # 1. ╨Я╨╛╨╗╤Г╤З╨░╨╡╨╝ ╨▒╨░╨╖╨╛╨▓╤Г╤О ╨╕╨╜╤Д╨╛ (╨┐╤А╨╛╤Д╨╕╨╗╤М, ╨║╨░╤В╨╡╨│╨╛╤А╨╕╨╕, ╨▒╨░╨╗╨░╨╜╤Б)
        info_task = self.get_customer_info(phone, organization_id=org_id)
        
        # 2. ╨Р╨╜╨░╨╗╨╕╤В╨╕╨║╨░ OLAP (LTV, ╤Б╤А╨╡╨┤╨╜╨╕╨╣ ╤З╨╡╨║ ╨╕ ╤В.╨┤.)
        ...
        # 4. ╨Х╤Б╨╗╨╕ ╨│╨╛╤Б╤В╤М ╨╜╨░╨╣╨┤╨╡╨╜, ╨┐╨╛╨┤╤В╤П╨│╨╕╨▓╨░╨╡╨╝ ╨╕╤Б╤В╨╛╤А╨╕╤О ╨▒╨╛╨╜╤Г╤Б╨╛╨▓ (╤В╤А╨╡╨▒╤Г╨╡╤В customerId ╨╕╨╖ info)
        bonus_history = {"transactions": []}
        customer_id = info.get("id")
        if customer_id:
            date_from = (datetime.now(timezone.utc) - timedelta(days=365)).strftime("%Y-%m-%d %H:%M:%S.000")
            try:
    ...
    async def get_organization_report(
        ...
        async def fetch_employees():
            try:
                ...
                # ╨Х╤Б╨╗╨╕ Resto ╨╜╨╡ ╨┐╨╛╨╝╨╛╨│, ╨┐╤А╨╛╨▒╤Г╨╡╨╝ /couriers ╨║╨░╨║ ╨┐╨╛╤Б╨╗╨╡╨┤╨╜╨╕╨╣ ╤И╨░╨╜╤Б (╨╕╨╜╨╛╨│╨┤╨░ ╨╜╨░ ╨╜╨╕╤Е ╨┐╤А╨░╨▓╨░ ╨╡╤Б╤В╤М)
                try:
        ...
        async def fetch_courier_locations():
            try:
                ...
                # ╨Ф╨╗╤П ╨╗╨╛╨║╨░╤Ж╨╕╨╣ ╨║╤Г╤А╤М╨╡╤А╨╛╨▓ ╨▓ Resto API ╨╜╨╡╤В ╨┐╤А╤П╨╝╨╛╨│╨╛ ╤Н╨║╨▓╨╕╨▓╨░╨╗╨╡╨╜╤В╨░ ╨▓ ╨╛╨┤╨╜╨╛╨╝ ╨╝╨╡╤В╨╛╨┤╨╡,
                # ╨┐╨╛╤Н╤В╨╛╨╝╤Г ╨┐╤А╨╛╤Б╤В╨╛ ╨▓╨╛╨╖╨▓╤А╨░╤Й╨░╨╡╨╝ ╨┐╤Г╤Б╤В╨╛╨╣ ╤Г╤Б╨┐╨╡╤Е, ╤З╤В╨╛╨▒╤Л ╨╜╨╡ ╨▓╨░╨╗╨╕╤В╤М ╨▓╨╡╤Б╤М ╨╛╤В╤З╨╡╤В
    ...
    async def get_customer_order_history_olap(
        ...
        """
        ╨Я╨╛╨╗╤Г╤З╨╡╨╜╨╕╨╡ ╨╕╤Б╤В╨╛╤А╨╕╨╕ ╨╖╨░╨║╨░╨╖╨╛╨▓ ╨│╨╛╤Б╤В╤П ╤З╨╡╤А╨╡╨╖ OLAP (Server API).
        ╨Т╨╛╨╖╨▓╤А╨░╤Й╨░╨╡╤В ╤Б╨┐╨╕╤Б╨╛╨║ ╨▓╤Л╨┐╨╛╨╗╨╜╨╡╨╜╨╜╤Л╤Е ╨╖╨░╨║╨░╨╖╨╛╨▓ ╤Б ╤Б╤Г╨╝╨╝╨░╨╝╨╕ ╨╕ ╨┤╨░╤В╨░╨╝╨╕.
        """
        org_id = organization_id or self.organization_id
        
        # ╨Ю╤З╨╕╤Й╨░╨╡╨╝ ╤В╨╡╨╗╨╡╤Д╨╛╨╜ ╨╛╤В ╨╗╨╕╤И╨╜╨╕╤Е ╤Б╨╕╨╝╨▓╨╛╨╗╨╛╨▓ (╨╜╤Г╨╢╨╜╤Л ╤В╨╛╨╗╤М╨║╨╛ ╤Ж╨╕╤Д╤А╤Л ╨┤╨╗╤П iiko)
        ...
        # ╨Я╨╡╤А╨╕╨╛╨┤: ╨╖╨░ ╨▓╤Б╨╡ ╨▓╤А╨╡╨╝╤П (╨╕╨╗╨╕ ╨╖╨░ ╨┐╨╛╤Б╨╗╨╡╨┤╨╜╨╕╨╡ 5 ╨╗╨╡╤В)
        date_from = datetime.now(timezone.utc) - timedelta(days=365*5)
        date_to = datetime.now(timezone.utc)

        # ╨Я╨╛╨╗╤П ╨┤╨╗╤П ╤Д╨╕╨╗╤М╤В╤А╨░╤Ж╨╕╨╕
        # ╨Т iiko ╨╝╨╛╨│╤Г╤В ╨╕╤Б╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╤М╤Б╤П ╤А╨░╨╖╨╜╤Л╨╡ ╨╕╨╝╨╡╨╜╨░ ╨┐╨╛╨╗╨╡╨╣ ╨▓ ╨╖╨░╨▓╨╕╤Б╨╕╨╝╨╛╤Б╤В╨╕ ╨╛╤В ╨▓╨╡╤А╤Б╨╕╨╕. 
        # ╨Я╤А╨╛╨▒╤Г╨╡╨╝ ╨┐╨╛╤Б╨╗╨╡╨┤╨╛╨▓╨░╤В╨╡╨╗╤М╨╜╨╛ ╤Б╨░╨╝╤Л╨╡ ╤З╨░╤Б╤В╤Л╨╡ ╨▓╨░╤А╨╕╨░╨╜╤В╤Л.
        phone_variants = [clean_phone, f"+{clean_phone}", phone]
        
        # ╨а╨░╤Б╤И╨╕╤А╨╡╨╜╨╜╤Л╨╣ ╤Б╨┐╨╕╤Б╨╛╨║ ╨┐╨╛╨╗╨╡╨╣ ╨┤╨╗╤П ╨┐╨╛╨╕╤Б╨║╨░ ╤В╨╡╨╗╨╡╤Д╨╛╨╜╨░ ╨▓ ╤А╨░╨╖╨╜╤Л╤Е ╨▓╨╡╤А╤Б╨╕╤П╤Е iiko
        ...
        for field in possible_fields:
            ...
            for agg_fields in aggregate_variants:
                try:
                    ...
                    if rows:
                        ...
                        for r in rows:
                            ...
                            processed.append({
                                ...
                                "sum": order_sum,
                                "status": "COMPLETED" # ╨Т ╤Н╤В╨╛╨╝ ╨╛╤В╤З╨╡╤В╨╡ ╤В╨╛╨╗╤М╨║╨╛ ╨▓╤Л╨┐╨╛╨╗╨╜╨╡╨╜╨╜╤Л╨╡ (SALES)
                            })
                    ...
                    continue # ╨Я╤А╨╛╨▒╤Г╨╡╨╝ ╤Б╨╗╨╡╨┤╤Г╤О╤Й╨╕╨╣ ╨╜╨░╨▒╨╛╤А ╨┐╨╛╨╗╨╡╨╣ ╨╕╨╗╨╕ ╤Б╨╗╨╡╨┤╤Г╤О╤Й╨╕╨╣ ╤Д╨╕╨╗╤М╤В╤А ╨┐╨╛ ╤В╨╡╨╗╨╡╤Д╨╛╨╜╤Г
    ...
    async def get_customer_analytics_olap(
        ...
        """
        ╨Я╨╛╨╗╤Г╤З╨╡╨╜╨╕╨╡ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╜╨╛╨╣ ╨░╨╜╨░╨╗╨╕╤В╨╕╨║╨╕ ╨│╨╛╤Б╤В╤П ╤З╨╡╤А╨╡╨╖ OLAP (Server API).
        """
        org_id = organization_id or self.organization_id
        ...
        # ╨Я╨╡╤А╨╕╨╛╨┤: 10 ╨╗╨╡╤В
        date_from = datetime.now(timezone.utc) - timedelta(days=365*10)
        date_to = datetime.now(timezone.utc)
        ...
        for field in possible_fields:
            ...
            # ╨б╨┐╨╕╤Б╨╛╨║ ╨┐╨╛╨╗╨╡╨╣ ╨░╨│╤А╨╡╨│╨░╤Ж╨╕╨╕ ╨┤╨╗╤П ╨┐╤А╨╛╨▒╤Л (╨╝╨╛╨│╤Г╤В ╨╛╤В╨╗╨╕╤З╨░╤В╤М╤Б╤П ╨▓ ╤А╨░╨╖╨╜╤Л╤Е ╨▓╨╡╤А╤Б╨╕╤П╤Е iiko)
            aggregate_variants = [
                ...
                ["fullSum", "DiscountSum", "UniqOrderId"] # ╨Ь╨╕╨╜╨╕╨╝╨░╨╗╤М╨╜╤Л╨╣ ╨╜╨░╨▒╨╛╤А
            ]
                ...
                try:
                    ...
                    if rows:
                        ...
                        return {
                            ...
                            "total_revenue": round(total_sum, 2), # ╨Ф╨╗╤П ╤Б╨╛╨▓╨╝╨╡╤Б╤В╨╕╨╝╨╛╤Б╤В╨╕
                            "total_count": total_count,
                            "orders_count": total_count, # ╨Ф╨╗╤П ╤Б╨╛╨▓╨╝╨╡╤Б╤В╨╕╨╝╨╛╤Б╤В╨╕
    ...
    async def get_daily_revenue_olap(
        ...
        ╨Ш╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╡╤В DishDiscountSumInt ╨║╨░╨║ ╨▒╨░╨╖╤Г ╨▓╤Л╤А╤Г╤З╨║╨╕.
        """
        try:
            ...
            for row in rows:
                ...
                if date_str:
                    try:
                        # ╨Ш╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╡╨╝ DishDiscountSumInt ╨┤╨╗╤П ╨▓╤Л╤А╤Г╤З╨║╨╕ (Net Revenue)
    ...
    async def get_custom_olap_report(
        ...
        try:
            ...
            # ╨Э╨╡ ╤Б╨┐╨░╨╝╨╕╨╝ ╨╛╤И╨╕╨▒╨║╨░╨╝╨╕ ╨▓ ╨╛╤Б╨╜╨╛╨▓╨╜╨╛╨╣ ╨╗╨╛╨│, ╨╡╤Б╨╗╨╕ ╤Н╤В╨╛ ╨┐╤А╨╛╤Б╤В╨╛ "╨╜╨╡╨▓╨╡╤А╨╜╨╛╨╡ ╨┐╨╛╨╗╨╡" (╨▒╤Г╨┤╨╡╤В ╨╛╤В╨╗╨╛╨▓╨╗╨╡╨╜╨╛ ╨▓╤Л╨╖╤Л╨▓╨░╤О╤Й╨╕╨╝ ╨╝╨╡╤В╨╛╨┤╨╛╨╝)
            logger.warning(f"Custom OLAP report ({report_type}) field/request failed: {e}")
            raise e # ╨Я╤А╨╛╨▒╤А╨░╤Б╤Л╨▓╨░╨╡╨╝ ╨▓╤Л╤И╨╡ ╨┤╨╗╤П ╨╛╨▒╤А╨░╨▒╨╛╤В╨║╨╕ ╨▓ ╤Ж╨╕╨║╨╗╨░╤Е retry
    ...
    async def _resto_request(
        ...
        if not base_url.endswith('/api'):
            ...
            # 1. ╨Я╨╛╨╗╤Г╤З╨░╨╡╨╝ ╤В╨╛╨║╨╡╨╜ (╤Б ╤А╨╡╤В╤А╨╕ ╨╜╨░ 403 "no connections")
            max_retries = 3
            token = None
            for attempt in range(max_retries):
                ...
                auth_response = await self.insecure_client.get(auth_url, params=auth_params, timeout=timeout)
                ...
                if auth_response.status_code != 200:
                    ...
                    auth_response = await self.insecure_client.get(auth_url, params={"login": login, "pass": password}, timeout=timeout)
            ...
            response = await self.insecure_client.request(method, request_url, params=final_params, json=json_data, timeout=timeout)
            
            # 3. ╨а╨░╨╖╨╗╨╛╨│╨╕╨╜╨╕╨▓╨░╨╡╨╝╤Б╤П (╨Ю╨С╨п╨Ч╨Р╨в╨Х╨Ы╨м╨Э╨Ю, ╤З╤В╨╛╨▒╤Л ╨╜╨╡ ╨╖╨░╨╜╨╕╨╝╨░╤В╤М ╨╗╨╕╤Ж╨╡╨╜╨╖╨╕╤О Resto API)
            try:
                logout_url = f"{base_url}/logout"
                await self.insecure_client.get(logout_url, params={"key": token}, timeout=5.0)
                logger.debug(f"Resto Session {token[:8]}... logged out successfully")
            except Exception as le:
                logger.warning(f"Failed to logout from Resto: {le}")

                if response.status_code >= 400:
                    # ╨б╨┐╨╡╤Ж╨╕╨░╨╗╤М╨╜╨░╤П ╨╛╨▒╤А╨░╨▒╨╛╤В╨║╨░ ╨┤╨╗╤П ╨╛╤И╨╕╨▒╨║╨╕ ╨╗╨╕╤Ж╨╡╨╜╨╖╨╕╨╕ iiko Resto
                    if response.status_code == 403 and "module REST_API" in response.text:
                        logger.error(f"╨Ю╨и╨Ш╨С╨Ъ╨Р ╨Ы╨Ш╨ж╨Х╨Э╨Ч╨Ш╨Ш IIKO: ╨Ь╨╛╨┤╤Г╨╗╤М REST API ╨╜╨╡ ╨░╨║╤В╨╕╨▓╨╡╨╜ ╨╜╨░ ╤Б╨╡╤А╨▓╨╡╤А╨╡ iiko. ╨в╤А╨╡╨▒╤Г╨╡╤В╤Б╤П ╨░╨║╤В╨╕╨▓╨░╤Ж╨╕╤П ╨╗╨╕╤Ж╨╡╨╜╨╖╨╕╨╕. ╨Ю╤В╨▓╨╡╤В ╤Б╨╡╤А╨▓╨╡╤А╨░: {response.text}")
                        raise HTTPException(
                            status_code=403, 
                            detail="╨Ю╤И╨╕╨▒╨║╨░ iiko: ╨Ю╤В╤Б╤Г╤В╤Б╤В╨▓╤Г╨╡╤В ╨╗╨╕╤Ж╨╡╨╜╨╖╨╕╤П ╨╜╨░ ╨╝╨╛╨┤╤Г╨╗╤М 'iiko Server API' (REST_API). ╨Я╨╛╨╢╨░╨╗╤Г╨╣╤Б╤В╨░, ╨╛╨▒╤А╨░╤В╨╕╤В╨╡╤Б╤М ╨▓ ╨┐╨╛╨┤╨┤╨╡╤А╨╢╨║╤Г iiko ╨┤╨╗╤П ╨░╨║╤В╨╕╨▓╨░╤Ж╨╕╨╕."
                        )
    ...
    async def get_resto_olap_columns(
        ...
        """╨Я╨╛╨╗╤Г╤З╨╡╨╜╨╕╨╡ ╤Б╨┐╨╕╤Б╨║╨░ ╨┤╨╛╤Б╤В╤Г╨┐╨╜╤Л╤Е ╨║╨╛╨╗╨╛╨╜╨╛╨║ ╨┤╨╗╤П OLAP-╨╛╤В╤З╨╡╤В╨░ (╨┤╨╕╨░╨│╨╜╨╛╤Б╤В╨╕╨║╨░)"""
        try:
    ...
    async def get_resto_detailed_deliveries(
        ...
        try:
            ...
            # ╨С╨░╨╖╨╛╨▓╤Л╨╡ ╨┐╨╛╨╗╤П ╨│╤А╤Г╨┐╨┐╨╕╤А╨╛╨▓╨║╨╕ ╨┤╨╗╤П DELIVERIES ╨╛╤В╤З╨╡╤В╨░
            base_fields = [
                "Delivery.Number", 
                "Delivery.Courier", 
                "Delivery.Courier.Id",
            ...
            # ╨а╨░╤Б╤И╨╕╤А╨╡╨╜╨╜╤Л╨╡ ╨┐╨╛╨╗╤П ╨░╨┤╤А╨╡╤Б╨░ (╨╝╨╛╨│╤Г╤В ╨╜╨╡ ╨┐╨╛╨┤╨┤╨╡╤А╨╢╨╕╨▓╨░╤В╤М╤Б╤П ╨▓ OLAP ╨╜╨░ ╨╜╨╡╨║╨╛╤В╨╛╤А╤Л╤Е ╨▓╨╡╤А╤Б╨╕╤П╤Е iiko)
            ...
            try:
                ...
                # ╨Х╤Б╨╗╨╕ 400 (Bad Request), ╨▓╨╡╤А╨╛╤П╤В╨╜╨╛ ╨║╨░╨║╨╛╨╡-╤В╨╛ ╨┐╨╛╨╗╨╡ ╨╜╨╡ ╨┐╨╛╨┤╨┤╨╡╤А╨╢╨╕╨▓╨░╨╡╤В╤Б╤П (╨╜╨░╨┐╤А╨╕╨╝╨╡╤А, Delivery.House)
                if "400" in str(e):
                ...
                # ╨Х╤Б╨╗╨╕ 404, ╨╖╨╜╨░╤З╨╕╤В v2 API ╨▓╨╛╨╛╨▒╤Й╨╡ ╨╜╨╡ ╨┐╨╛╨┤╨┤╨╡╤А╨╢╨╕╨▓╨░╨╡╤В╤Б╤П ╤Б╨╡╤А╨▓╨╡╤А╨╛╨╝ iiko, ╨┐╤А╨╛╨▒╤Г╨╡╨╝ v1 (GET)
                elif "404" in str(e):
                    logger.info("Resto API v2 not found, falling back to v1 (GET)")
                    v1_from = date_from.strftime("%d.%m.%Y")
                    v1_to = date_to.strftime("%d.%m.%Y")
                    ...
                    # ╨Ф╤А╤Г╨│╨╕╨╡ ╨╛╤И╨╕╨▒╨║╨╕ (╨╜╨░╨┐╤А╨╕╨╝╨╡╤А 401 ╨╕╨╗╨╕ 403 ╨Ы╨╕╤Ж╨╡╨╜╨╖╨╕╤П) ╨┐╤А╨╛╨▒╤А╨░╤Б╤Л╨▓╨░╨╡╨╝ ╨▓╤Л╤И╨╡
                    raise e
            ...
            for row in data_rows:
                # ╨Я╤Л╤В╨░╨╡╨╝╤Б╤П ╨┐╨╛╨╗╤Г╤З╨╕╤В╤М ╨░╨┤╤А╨╡╤Б ╨╕╨╖ ╤А╨░╨╖╨╜╤Л╤Е ╨┐╨╛╨╗╨╡╨╣ (╨╖╨░╨▓╨╕╤Б╨╕╤В ╨╛╤В ╨▓╨╡╤А╤Б╨╕╨╕ API ╨╕ ╨╜╨░╤Б╤В╤А╨╛╨╡╨║ iiko)
                raw_address = row.get("Delivery.Address", row.get("delivery.address", ""))
                line1 = row.get("Delivery.Line1", row.get("delivery.line1", ""))
                
                # ╨б╨╛╨▒╨╕╤А╨░╨╡╨╝ ╤З╨░╤Б╤В╨╕ ╨┤╨╗╤П ╤Б╨╛╨▓╨╝╨╡╤Б╤В╨╕╨╝╨╛╤Б╤В╨╕ ╤Б format_address ╨▓ iiko_sync_service
                # ╨Я╨╛╨┤╨┤╨╡╤А╨╢╨╕╨▓╨░╨╡╨╝ ╤А╨░╨╖╨╜╤Л╨╡ ╨▓╨░╤А╨╕╨░╨╜╤В╤Л ╤А╨╡╨│╨╕╤Б╤В╤А╨░ ╨║╨╗╤О╤З╨╡╨╣ (v1 vs v2)
                addr_parts = {
