...
def check_manifest(ip, pwd):
    ...
    try:
        ...
        print("--- Vite Manifest ---")
        stdin, stdout, stderr = client.exec_command("cat /root/foodzuka/admin/public/build/manifest.json")
...
if __name__ == "__main__":
    check_manifest("178.212.13.48", "12101991Qq")
